  ...
  return `
    <article class="card reveal" data-category="${resource.category}">
      ...
      <div class="card__actions">
        <button class="button button--primary" type="button" data-open-download data-resource-title="${resource.title}">
          Descargar
        </button>
      </div>
    </article>
  ...
  return `
    <article class="carousel__item">
      <div class="card">
        ...
        <p>${resource.description}</p>
        <div class="card__actions">
          <button class="button button--ghost" type="button" data-open-download data-resource-title="${resource.title}">
            Lo quiero
          </button>
        </div>
      </div>
...
export function createEmotionCard(emotion) {
  return `
    <article class="emotion-card reveal">
      ...
      <div class="card__actions">
        <button class="button button--ghost" type="button" data-open-download data-resource-title="Recurso de ${emotion.name}">
          Recurso descargable
        </button>
      </div>
    </article>
...
export function createServiceCard(service) {
  return `
    <article class="service-card reveal">
      ...
      <div class="card__actions">
        <a class="button button--ghost" href="#contacto">Solicitar información</a>
      </div>
    </article>
  `;
}
